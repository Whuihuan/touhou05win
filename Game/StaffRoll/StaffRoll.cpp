...
void CStaffRoll::Initialize(int edType)
{
	m_curFrame=0;
...
int CStaffRoll::ReadNumber(int defValue)
{
...
int CStaffRoll::ReadNumberComma(int defValue)
{
	if (m_pScript[0]==',')
	{
		m_pScript++;
...
void CStaffRoll::DrawText(vector<unsigned char> &text,unsigned char colorIdx, int scale)
{
